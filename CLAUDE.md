...
- **Category taxonomy:** `provider` ("add LLM X") · `theme` · `skill` · `slash-command` · `renderer` (fenced-code renderers, T42) (`PluginCategory` in `src/types/plugins.ts`; `CATEGORIES` in Rust).
