...
export const en = {
  ...
  "chat.approveAlways": "Always allow read-only tools",
  "chat.approvalRisk": "⚠ This command is not read-only: it {risk}.",
  "chat.deny": "Deny",
  ...
  // Model-pill hover detail: what generated this reply.
  "chat.modelInfo.model": "Model",
  "chat.modelInfo.outputStyle": "Output style",
  "chat.modelInfo.tools": "Tools used",
  "chat.modelInfo.noTools": "None",
  "chat.modelInfo.planner": "Planner",
  "chat.modelInfo.strategy": "Strategy",
  "chat.modelInfo.steps": "Steps",
  "chat.modelInfo.plannerModels": "Models used",
  "chat.modelInfo.strategyDirect": "Direct",
  "chat.modelInfo.strategyRoute": "Routed",
  "chat.modelInfo.strategyMultiStep": "Multi-step",
  "chat.copy": "Copy",
  "chat.copied": "Copied",
  ...
  "mcp.sysAutoApproveExplain":
    "Auto mode runs the read-only tools (list, read, search, diagnostics) without asking each time. The arbitrary command runner always asks.",
  "mcp.sysAutoApproveOn": "Auto-approve read-only tools",
  "mcp.sysAutoApproveOff": "Ask each time",
