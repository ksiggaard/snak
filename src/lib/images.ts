...
/** Save a rendered Mermaid (or any) SVG diagram as a `.svg` file (T44). */
export async function downloadSvg(svg: string): Promise<boolean> {
 ...
 * small diagram blows up to fit the viewport instead of staying tiny.
 */
