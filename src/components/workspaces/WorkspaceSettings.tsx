...
import { ArrowLeft, FileText, Globe, Loader2, Trash2, Upload } from "lucide-react";
  ...
  return (
    <div className="bg-card flex flex-1 flex-col gap-5 overflow-y-auto rounded-lg border p-5">
      ...
      <div className="flex items-center gap-2 pb-2">
        ...
        <h2 className="text-sm font-medium">{t("workspace.settingsPage")}</h2>
      </div>
